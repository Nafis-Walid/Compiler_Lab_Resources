...
|in this stage we have to include the filename.tab.h file to the filename.l file by using |
|the command below                                                                        |        
|                    %{                                                                   |
|                    #include "cal.tab.h"                                                 |
|                    %}                                                                   |              
...
________________________________________________________________________________________________________________
                                                    Summary
* process the parser file using bison(command: bison -d cal.y)
        * this will create two extra file with .tab.c and .tab.h
        * Include the file with extension .tab.c to the lexer file
* process the lexer file using lex(command: flex cal.l)
